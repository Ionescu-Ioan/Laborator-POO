...
Formatie::Formatie(const std::string &nume_formatie, const std::string &date)
{
    this->nume_formatie->set_brand(nume_formatie);
    this->informatii->set_informatii(date);
}

std::string Formatie::get_nume_formatie()
{
    return nume_formatie->get_denumire();
}


std::string Formatie::get_informatii()
{
    return informatii->get_info();
}
